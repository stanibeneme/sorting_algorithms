...
/**
 * lomuto_partition - An Order to a subset of an array of integers to
 ...
 * Project by Stanley Ibeneme
 * Return: The final of partition index.
 */
int lomuto_partition(int *array, size_t size, int left, int right)
{
...
/**
 * quick_sort - This sorts array of integers in ascending
