...
/**
 * _strcmp - This fubction Compares two strings.
 ...
 * @deck: The pointer to the head of deck_node_t doubly-linked list.
 * Project by Stanley Ibeneme
 */
void insertion_sort_deck_kind(deck_node_t **deck)
{
...
/**
 * insertion_sort_deck_value - Sort the deck of cards sorted from
